...
std::unique_ptr<AbstractShader> Gfx::CreateShaderFromSource(ShaderStage stage,
...
{
  D3D::stateman->SetTexture(index,
      texture ? static_cast<const DXTexture*>(texture)->GetD3DSRV() : nullptr);
}
