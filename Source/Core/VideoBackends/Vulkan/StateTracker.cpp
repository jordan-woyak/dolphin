...
void StateTracker::UpdateGXDescriptorSet()
{
  ...
  {
    m_gx_descriptor_sets[2] = g_command_buffer_mgr->AllocateDescriptorSet(g_object_cache
            ->GetDescriptorSetLayout(DESCRIPTOR_SET_LAYOUT_STANDARD_SHADER_STORAGE_BUFFERS));
