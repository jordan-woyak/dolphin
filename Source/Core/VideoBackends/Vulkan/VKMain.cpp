...
bool VideoBackend::Initialize(const WindowSystemInfo& wsi)
{
  ...
  u32 vk_api_version = 0;
  VkInstance instance = VulkanContext::CreateVulkanInstance(wsi.type, enable_debug_utils,
  ...
  VulkanContext::PopulateBackendInfoMultisampleModes(&g_backend_info,
      g_vulkan_context->GetPhysicalDevice(), g_vulkan_context->GetDeviceInfo());
