...
bool VulkanContext::CheckValidationLayerAvailablility()
{
  ...
  bool supports_validation_layers = Common::Contains(layer_list,
      std::string_view{VALIDATION_LAYER_NAME}, &VkLayerProperties::layerName);
...
void VulkanContext::PopulateBackendInfoMultisampleModes(BackendInfo* backend_info,
    VkPhysicalDevice gpu, const PhysicalDeviceInfo& info)
{
