    ...
    const CustomShaderInstance& custom_shaders, const AbstractPipelineConfig& pipeline_config)
{
  ...
  auto work_item = m_async_shader_compiler->CreateWorkItem<PipelineWorkItem>(this, uid,
      custom_shaders, list_iter, pipeline_config);
    ...
    const CustomShaderInstance& custom_shaders, const AbstractPipelineConfig& pipeline_config)
{
  ...
  auto work_item = m_async_uber_shader_compiler->CreateWorkItem<PipelineWorkItem>(this, uid,
      custom_shaders, list_iter, pipeline_config);
    ...
    const CustomShaderInstance& custom_shaders)
{
  ...
  auto work_item = m_async_shader_compiler->CreateWorkItem<PixelShaderWorkItem>(this, uid,
      custom_shaders, list_iter);
  m_async_shader_compiler->QueueWorkItem(std::move(work_item), 0);
}
    ...
    const CustomShaderInstance& custom_shaders)
{
  ...
  auto work_item = m_async_uber_shader_compiler->CreateWorkItem<PixelShaderWorkItem>(this, uid,
      custom_shaders, list_iter);
  m_async_uber_shader_compiler->QueueWorkItem(std::move(work_item), 0);
}

std::unique_ptr<AbstractShader> CustomShaderCache::CompilePixelShader(const PixelShaderUid& uid,
