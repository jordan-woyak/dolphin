...
#define DescriptionlessReg(reg) std::make_pair(RegName(reg), "");
  ...
  case BPMEM_TX_SETIMAGE0 + 3:
    return std::make_pair(fmt::format("BPMEM_TX_SETIMAGE0 Texture Unit {}",
                              cmd - BPMEM_TX_SETIMAGE0),
  ...
  case BPMEM_TX_SETIMAGE1 + 3:
    return std::make_pair(fmt::format("BPMEM_TX_SETIMAGE1 Texture Unit {}",
                              cmd - BPMEM_TX_SETIMAGE1),
  ...
  case BPMEM_TX_SETIMAGE2 + 3:
    return std::make_pair(fmt::format("BPMEM_TX_SETIMAGE2 Texture Unit {}",
                              cmd - BPMEM_TX_SETIMAGE2),
  ...
  case BPMEM_TX_SETIMAGE3 + 3:
    return std::make_pair(fmt::format("BPMEM_TX_SETIMAGE3 Texture Unit {}",
                              cmd - BPMEM_TX_SETIMAGE3),
  ...
  case BPMEM_TX_SETMODE0_4 + 3:
    return std::make_pair(fmt::format("BPMEM_TX_SETMODE0_4 Texture Unit {}",
                              cmd - BPMEM_TX_SETMODE0_4 + 4),
        fmt::to_string(TexMode0{.hex = cmddata}));
  ...
  case BPMEM_TX_SETMODE1_4 + 3:
    return std::make_pair(fmt::format("BPMEM_TX_SETMODE1_4 Texture Unit {}",
                              cmd - BPMEM_TX_SETMODE1_4 + 4),
        fmt::to_string(TexMode1{.hex = cmddata}));
  ...
  case BPMEM_TX_SETIMAGE0_4 + 3:
    return std::make_pair(fmt::format("BPMEM_TX_SETIMAGE0_4 Texture Unit {}",
  ...
  case BPMEM_TX_SETIMAGE1_4 + 3:
    return std::make_pair(fmt::format("BPMEM_TX_SETIMAGE1_4 Texture Unit {}",
  ...
  case BPMEM_TX_SETIMAGE2_4 + 3:
    return std::make_pair(fmt::format("BPMEM_TX_SETIMAGE2_4 Texture Unit {}",
  ...
  case BPMEM_TX_SETIMAGE3_4 + 3:
    return std::make_pair(fmt::format("BPMEM_TX_SETIMAGE3_4 Texture Unit {}",
  ...
  case BPMEM_TEV_COLOR_ENV + 30:
    return std::make_pair(fmt::format("BPMEM_TEV_COLOR_ENV Tev stage {}",
                              (cmd - BPMEM_TEV_COLOR_ENV) / 2),
  ...
  case BPMEM_TEV_ALPHA_ENV + 30:
    return std::make_pair(fmt::format("BPMEM_TEV_ALPHA_ENV Tev stage {}",
                              (cmd - BPMEM_TEV_ALPHA_ENV) / 2),
  ...
  case BPMEM_TEV_COLOR_RA + 6:  // 0xE6
    return std::make_pair(fmt::format("BPMEM_TEV_COLOR_RA Tev register {}",
                              (cmd - BPMEM_TEV_COLOR_RA) / 2),
  ...
  case BPMEM_TEV_COLOR_BG + 6:  // 0xE7
    return std::make_pair(fmt::format("BPMEM_TEV_COLOR_BG Tev register {}",
                              (cmd - BPMEM_TEV_COLOR_BG) / 2),
