...
void ColorCorrectionConfigWindow::Create()
{
  ...
  m_sdr_display_custom_gamma_value->setText(QString::asprintf("%.2f",
      m_sdr_display_custom_gamma->GetValue()));
  ...
  m_hdr_paper_white_nits_value->setText(QString::asprintf("%.0f",
      m_hdr_paper_white_nits->GetValue()));
