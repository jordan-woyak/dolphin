...
void WiimoteEmuExtension::CreateDrumsLayout()
{
  ...
  layout->addWidget(CreateGroupBox(tr("Pads"),
                        Wiimote::GetDrumsGroup(GetPort(), WiimoteEmu::DrumsGroup::Pads)),
      0, 1);
  layout->addWidget(CreateGroupBox(tr("Buttons"),
...
void WiimoteEmuExtension::CreateGuitarLayout()
{
  ...
  vbox->addWidget(CreateGroupBox(tr("Stick"),
      Wiimote::GetGuitarGroup(GetPort(), WiimoteEmu::GuitarGroup::Stick)));
  hbox->addLayout(vbox);

  auto* vbox2 = new QVBoxLayout();
  vbox2->addWidget(CreateGroupBox(tr("Strum"),
      Wiimote::GetGuitarGroup(GetPort(), WiimoteEmu::GuitarGroup::Strum)));
  vbox2->addWidget(CreateGroupBox(tr("Frets"),
      Wiimote::GetGuitarGroup(GetPort(), WiimoteEmu::GuitarGroup::Frets)));
  hbox->addLayout(vbox2);

  auto* vbox3 = new QVBoxLayout();
  vbox3->addWidget(CreateGroupBox(tr("Buttons"),
      Wiimote::GetGuitarGroup(GetPort(), WiimoteEmu::GuitarGroup::Buttons)));
  vbox3->addWidget(CreateGroupBox(tr("Whammy"),
      Wiimote::GetGuitarGroup(GetPort(), WiimoteEmu::GuitarGroup::Whammy)));
  vbox3->addWidget(CreateGroupBox(tr("Slider Bar"),
      Wiimote::GetGuitarGroup(GetPort(), WiimoteEmu::GuitarGroup::SliderBar)));
...
void WiimoteEmuExtension::CreateTurntableLayout()
{
  ...
  layout->addWidget(CreateGroupBox(
                        // i18n: "Table" refers to a turntable
                        tr("Right Table"), Wiimote::GetTurntableGroup(GetPort(),
                                               WiimoteEmu::TurntableGroup::RightTable)),
      1, 2);
...
void WiimoteEmuExtension::CreateUDrawTabletLayout()
{
  ...
  hbox->addWidget(CreateGroupBox(tr("Touch"),
      Wiimote::GetUDrawTabletGroup(GetPort(), WiimoteEmu::UDrawTabletGroup::Touch)));
...
void WiimoteEmuExtension::CreateTaTaConLayout()
{
  ...
  hbox->addWidget(CreateGroupBox(tr("Center"),
      Wiimote::GetTaTaConGroup(GetPort(), WiimoteEmu::TaTaConGroup::Center)));
  hbox->addWidget(CreateGroupBox(tr("Rim"),
      Wiimote::GetTaTaConGroup(GetPort(), WiimoteEmu::TaTaConGroup::Rim)));
...
void WiimoteEmuExtension::CreateShinkansenLayout()
{
  ...
  hbox->addWidget(CreateGroupBox(tr("Levers"),
      Wiimote::GetShinkansenGroup(GetPort(), WiimoteEmu::ShinkansenGroup::Levers)));
  hbox->addWidget(CreateGroupBox(tr("Buttons"),
      Wiimote::GetShinkansenGroup(GetPort(), WiimoteEmu::ShinkansenGroup::Buttons)));
  hbox->addWidget(CreateGroupBox(tr("Light"),
      Wiimote::GetShinkansenGroup(GetPort(), WiimoteEmu::ShinkansenGroup::Light)));
