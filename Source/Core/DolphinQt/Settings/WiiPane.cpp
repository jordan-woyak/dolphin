      ...
      [this]
      {
        ...
        if (result == QMessageBox::Yes)
        {
          ...
          auto success = std::async(std::launch::async,
              [&]
              {
                const bool good = Common::SyncSDFolderToSDImage([&progress_dialog]
                    { return progress_dialog.WasCanceled(); }, false);
      ...
      [this]
      {
        ...
        if (result == QMessageBox::Yes)
        {
          ...
          auto success = std::async(std::launch::async,
              [&]
              {
                const bool good = Common::SyncSDImageToSDFolder([&progress_dialog]
