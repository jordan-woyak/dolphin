...
{
  QString file = QDir::toNativeSeparators(DolphinFileDialog::getOpenFileName(this,
      tr("Select a Game"), Settings::Instance().GetDefaultGame(),
...
{
  QString dir = QDir::toNativeSeparators(DolphinFileDialog::getExistingDirectory(this,
      tr("Select Wii NAND Root"), QString::fromStdString(Config::Get(Config::MAIN_FS_PATH))));
  if (!dir.isEmpty())
  {
...
{
  QString dir = QDir::toNativeSeparators(DolphinFileDialog::getExistingDirectory(this,
      tr("Select Dump Path"), QString::fromStdString(Config::Get(Config::MAIN_DUMP_PATH))));
  if (!dir.isEmpty())
  {
...
{
  QString dir = QDir::toNativeSeparators(DolphinFileDialog::getExistingDirectory(this,
      tr("Select Load Path"), QString::fromStdString(Config::Get(Config::MAIN_LOAD_PATH))));
  if (!dir.isEmpty())
  {
...
{
  const QString dir = QDir::toNativeSeparators(DolphinFileDialog::getExistingDirectory(this,
      tr("Select WFS Path"), QString::fromStdString(Config::Get(Config::MAIN_WFS_PATH))));
  if (!dir.isEmpty())
  {
...
QGroupBox* PathPane::MakeGameFolderBox()
{
  ...
  connect(&Settings::Instance(), &Settings::PathRemoved, this,
