...
void MemoryViewWidget::OnContextMenu(const QPoint& pos)
{
  ...
  auto* note_add_action = menu->addAction(tr("Add Note"), this,
      [this, addr] { OnEditSymbol(EditSymbolType::AddNote, addr); });
  auto* note_edit_action = menu->addAction(tr("Edit Note"), this,
      [this, addr] { OnEditSymbol(EditSymbolType::EditNote, addr); });
