...
void Init()
{
  ...
  try
  {
    ...
    s_event_added = WGI::RawGameController::RawGameControllerAdded(
        ...
        {
          s_device_add_remove_queue.EmplaceItem(AddRemoveEvent{
              AddRemoveEventType::AddOrReplace, std::move(raw_game_controller)});
        });
    ...
    s_event_removed = WGI::RawGameController::RawGameControllerRemoved(
        ...
        {
          s_device_add_remove_queue.EmplaceItem(AddRemoveEvent{
              AddRemoveEventType::Remove, std::move(raw_game_controller)});
        });
  }
  catch (winrt::hresult_error)
  {
