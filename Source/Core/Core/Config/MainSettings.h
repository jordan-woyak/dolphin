...
extern const std::array<Info<bool>, 4> MAIN_EMULATE_LOGITECH_MIC;
extern const std::array<Info<std::string>, 4> MAIN_LOGITECH_MIC_MICROPHONE;
extern const std::array<Info<bool>, 4> MAIN_LOGITECH_MIC_MUTED;
extern const std::array<Info<s16>, 4> MAIN_LOGITECH_MIC_VOLUME_MODIFIER;
