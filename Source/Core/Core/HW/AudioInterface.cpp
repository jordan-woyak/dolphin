...
void AudioInterfaceManager::RegisterMMIO(MMIO::Mapping* mmio, u32 base)
{
                 ...
                 MMIO::ComplexWrite<u32>([](Core::System& system, u32, u32 val)
  {
    ...
    if (tmp_ai_ctrl.AISFR != ai.m_control.AISFR)
    {
      ...
      DEBUG_LOG_FMT(AUDIO_INTERFACE, "Change AISFR to {}", tmp_ai_ctrl.AISFR ? "48khz" : "32khz");
    ...
    {
      DEBUG_LOG_FMT(AUDIO_INTERFACE, "Change AIDFR to {}", tmp_ai_ctrl.AIDFR ? "32khz" : "48khz");
    ...
    {
      DEBUG_LOG_FMT(AUDIO_INTERFACE, "{} streaming audio", tmp_ai_ctrl.PSTAT ? "start" : "stop");
  ...
  {
    auto& ai = system.GetAudioInterface();
    const u64 cycles_streamed = ai.IsPlaying() ?
                                    (system.GetCoreTiming().GetTicks() - ai.m_last_cpu_time) :
                                    ai.m_last_cpu_time;
    return ai.m_sample_counter + static_cast<u32>(cycles_streamed / ai.m_cpu_cycles_per_sample);
  }),
                 MMIO::ComplexWrite<u32>([](Core::System& system, u32, u32 val)
  {
    auto& core_timing = system.GetCoreTiming();
