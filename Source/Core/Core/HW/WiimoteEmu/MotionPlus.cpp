...
void MotionPlus::Update(const DesiredExtensionState& target_state)
{
  ...
  {
    constexpr u8 param_x[64] = {
        0x00, 0x00, 0x44, 0x38, 0xb2, 0xc9, 0xba, 0x61, 0xe2, 0x50, 0x9e, 0x53, 0x06,
        0xbe, 0xa5, 0x35, 0x0a, 0x81, 0xf0, 0x53, 0x7e, 0x70, 0x27, 0x62, 0xc5, 0xdf,
        0xbe, 0x52, 0x13, 0x22, 0x72, 0xa3, 0x28, 0x25, 0x1b, 0x7c, 0xb5, 0x48, 0xe4,
        0xd5, 0x37, 0x45, 0x98, 0xc4, 0x5a, 0x16, 0x4f, 0x3d, 0xdc, 0x81, 0x6a, 0x93,
        0xd1, 0x24, 0xd8, 0x52, 0xb3, 0xd6, 0x1a, 0x39, 0x3a, 0x12, 0x00, 0x00,
    };

    std::ranges::copy(param_x, m_reg_data.challenge_data.data());
  ...
  case ChallengeState::PreparingY:
    if (0 == m_reg_data.challenge_type)
    {
      // "DOLPHIN DOES WHAT NINTENDON'T."
      constexpr u8 param_y0[64] = {
          0x00, 0x2e, 0x54, 0x27, 0x4e, 0x4f, 0x44, 0x4e, 0x45, 0x54, 0x4e, 0x49, 0x4e,
          0x20, 0x54, 0x41, 0x48, 0x57, 0x20, 0x53, 0x45, 0x4f, 0x44, 0x20, 0x4e, 0x49,
          0x48, 0x50, 0x4c, 0x4f, 0x44, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
          0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
      };

      std::ranges::copy(param_y0, m_reg_data.challenge_data.data());
    }
    else
    {
      constexpr u8 param_y1[64] = {
          0xaa, 0x4b, 0xba, 0xfd, 0xe9, 0xfe, 0xff, 0x8a, 0x91, 0x0f, 0xa1, 0xec, 0x60,
          0xc6, 0x5c, 0xf8, 0x46, 0x59, 0xe9, 0xa0, 0xc2, 0x73, 0xbd, 0x7f, 0xcf, 0x7c,
          0xd6, 0x39, 0x32, 0x70, 0x45, 0x00, 0x99, 0x4f, 0x87, 0xe0, 0x22, 0xfc, 0xce,
          0xf8, 0x8a, 0xbb, 0x87, 0x34, 0xd5, 0xc8, 0x08, 0x69, 0xe1, 0xa9, 0x27, 0x2f,
          0xef, 0x81, 0xde, 0x66, 0xac, 0x33, 0x68, 0x1d, 0x58, 0xc3, 0x44, 0x2e,
      };

      std::ranges::copy(param_y1, m_reg_data.challenge_data.data());
    }
