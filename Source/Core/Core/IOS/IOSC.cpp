...
namespace IOS::HLE
{
constexpr std::array<u8, 512> ROOT_PUBLIC_KEY = {{}};

constexpr std::array<u8, 512> ROOT_PUBLIC_KEY_DEV = {{}};
...
void IOSC::LoadDefaultEntries()
{
  ...
  m_key_entries[HANDLE_CONSOLE_KEY] = {TYPE_SECRET_KEY, ObjectSubType::ECC233,
      {DEFAULT_PRIVATE_KEY.begin(), DEFAULT_PRIVATE_KEY.end()}, 3};
  ...
  m_key_entries[HANDLE_FS_KEY] = {
      TYPE_SECRET_KEY, ObjectSubType::AES128, std::vector<u8>(AES128_KEY_SIZE), 5};
  ...
  case ConsoleType::Retail:
    m_key_entries[HANDLE_COMMON_KEY] = {TYPE_SECRET_KEY, ObjectSubType::AES128,
    ...
    m_root_key_entry = {TYPE_PUBLIC_KEY, ObjectSubType::RSA4096,
        std::vector<u8>(ROOT_PUBLIC_KEY.begin(), ROOT_PUBLIC_KEY.end()), Common::swap32(0x00010001),
        0};
  ...
  case ConsoleType::RVT:
    m_key_entries[HANDLE_COMMON_KEY] = {TYPE_SECRET_KEY, ObjectSubType::AES128,
        {{0xa1, 0x60, 0x4a, 0x6a, 0x71, 0x23, 0xb5, 0x29, 0xae, 0x8b, 0xec, 0x32, 0xc8, 0x16, 0xfc,
            0xaa}},
        3};
    m_root_key_entry = {TYPE_PUBLIC_KEY, ObjectSubType::RSA4096,
  ...
  m_key_entries[HANDLE_PRNG_KEY] = {
      TYPE_SECRET_KEY, ObjectSubType::AES128, std::vector<u8>(AES128_KEY_SIZE), 3};

  m_key_entries[HANDLE_SD_KEY] = {TYPE_SECRET_KEY, ObjectSubType::AES128,
      {{0xab, 0x01, 0xb9, 0xd8, 0xe1, 0x62, 0x2b, 0x08, 0xaf, 0xba, 0xd8, 0x4d, 0xbf, 0xc2, 0xa5,
          0x5d}},
      3};
  ...
  m_key_entries[HANDLE_NEW_COMMON_KEY] = {TYPE_SECRET_KEY, ObjectSubType::AES128,
