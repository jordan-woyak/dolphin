...
private:
  ...
  // Too low a value crackles in-game, but too high a value adds latency. This could be user
  // adjustable in the future. Lego Rock Band sets the sample rate to 48000Hz, while Rock Band 3
  // uses 11025Hz. Titles with lower sample rates can afford lower stream sizes.
  static constexpr u32 STREAM_SIZE = BUFF_SIZE_SAMPLES * 96;
